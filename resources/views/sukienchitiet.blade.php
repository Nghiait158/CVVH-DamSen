...
<div class="contentSuKienChiTiet">
    <div class="imgHead-SuKienChiTiet">
        @foreach ($images as $image)
            <img src="{{($image->eImgPath)}}" alt="Image Event">
        @endforeach
    </div>

    <div class="introduce-sukien">
        <p class="eName-SuKienChiTiet">{{ $sukienchitiet -> eName }}</p>
        <div class="linebw-SuKienChiTiet"></div>

        <div class="under-introduce-sukien">
            ...
            <p class="sapdienra-SuKienChiTiet" >{{ $sukienchitiet -> eStatus }}</p>
            ...
            <p class="sapdienra-SuKienChiTiet">{{ $sukienchitiet -> eDate }}</p>
        </div>
    </div>
    <div class="introduceRight-sukien">
        <p class="mota-SuKienChiTiet">Mô Tả</p>

        <div class="linebw2-SuKienChiTiet"></div>
        <p class="DescE-SuKienChiTiet">{{ $sukienchitiet -> eDescription }}</p>
    </div>
