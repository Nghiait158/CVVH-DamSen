    ...
    <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    Cập nhật Thucvat vào cơ sở dữ liệu  
                </header>
                 <?php
                ...
                <div class="panel-body">
                    ...
                    <div class="position-center">
                        <form role="form" action="{{URL::to('/updateThucVat/'.$editThucVat-> tvID )}}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        <div class="form-group">
                            <label for="tvID">tvID</label>
                            <input type="text" value="{{ $editThucVat->tvID}}"  class="form-control" name="tvID" id="tvID">
                        </div>    
                        <div class="form-group">
                            <label for="tvName">Tên hình ảnh(tvName)</label>
                            <input type="text" value="{{ $editThucVat->tvName}}"  class="form-control" name="tvName"  id="tvName">
                        </div>
                        <div class="form-group">
                            <label for="tvStatus">Trạng thái ThucVat (tvStatus)</label>
                            <input type="text"value="{{ $editThucVat->tvStatus}}" class="form-control" name="tvStatus"  id="tvStatus" >
                        </div>
                         <div class="form-group">
                            <label for="tvDate">Ngày ThucVat(tvDate)</label>
                            <input type="text" value="{{ $editThucVat->tvDate}}" class="form-control" name="tvDate"  id="tvDate" >
                        </div>
                        <div class="form-group">
                            <label for="tvDescription">Mô tả ThucVat(tvDescription)</label>
                            <input type="text" value="{{ $editThucVat->tvDescription}}" class="form-control" name="tvDescription"  id="tvDescription" >
                        </div>
                        <div class="form-group">
                            <label for="tvContent">Content(tvContent)</label>
                            <textarea style="width: 994px; height: 237px;" value="{{ $editThucVat->tvContent}}" class="form-control tiny" name="tvContent" id="tvContent" ></textarea>
                        </div>
                        <div class="form-group">
                            <label for="tvContentCSS">Content CSS(tvContentCSS)</label>
                            <textarea style="width: 994px; height: 237px;" value="{{ $editThucVat->tvContentCSS}}" type="text" class="form-control" name="tvContentCSS"  id="tvContentCSS"></textarea>
                        </div>
                            
                        <div class="form-group">
                            <label for="tvContentJS">Content JS(tvContentJS)</label>
                            <textarea style="width: 994px; height: 237px;" value="{{ $editThucVat->tvContentJS}}" type="text" class="form-control" name="tvContentJS"  id="tvContentJS"></textarea>
                        </div>
                        <div class="form-group">
