      ...
      <table class="table table-striped b-t b-light">
        ...
        @foreach ($allEventImg ?? [] as $img)
          <tr>
            ...
            <td>
              <a href="{{ URL::to('/editTicketImg/'.$img->eImgID) }}" class="active styling-edit" ui-toggle-class=""> 
                <i class="fa fa-pencil-square-o text-success text-active"></i></a>
           <a onclick="return confirm('Bạn có chắc là muốn xóa hình ảnh này ko?')" href="{{ URL::to('/deleteTicketImg/'.$img->eImgID) }}" class="active styling-edit" ui-toggle-class=""> 
